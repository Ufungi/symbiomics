...
|---|---|
| OS | Linux |
| 오케스트레이터 | [Nextflow](https://www.nextflow.io/) ≥ 24.10 (Java 17–24 필요) |
...
지정하는데, Nextflow는 Java 17–24가 필요하지만 많은 호스트의 기본값은 Java 11이기
때문입니다.

```bash
which nextflow    # `conda activate symbiomics` 이후에만 resolve 됨 — 또는
